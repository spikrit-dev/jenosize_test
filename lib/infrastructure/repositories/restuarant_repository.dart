...
// abstract class RestuarantRepository {
...
// class RestuarantDefaultRepository extends RestuarantRepository {
//   RestuarantDefaultRepository({
...
//     if (!hasCachedData) {
//       final restuarantGithubModels = await githubDataSource.getRestuarants();
